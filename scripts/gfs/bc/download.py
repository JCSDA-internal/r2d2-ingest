...
def download_gfs(yaml_file):
    ...
    for date in dates:
        ...
        for gfs_file_type in gfs_file_types:
            file_name = f'gdas.t{hour}z.{gfs_file_type}'
            source = f's3://noaa-gfs-bdp-pds/gdas.{day}/{hour}/atmos/{file_name}'
            target = f'file://{download_dir}/gdas.{day}/{hour}/atmos/{file_name}'
